  ...
  if (gameState === "finished") {
    return (
      <>
        ...
        <div
          className={`max-h-[60vh] mt-50 flex items-center justify-center p-6 transition-all duration-300 ${finishedScreenFadeOut ? "opacity-0 transform scale-95" : "opacity-100 transform scale-100"
            }`}
        >
          <Card className="w-full max-w-6xl bg-white/95 backdrop-blur-sm shadow-2xl">
            <CardContent className="p-2 text-center">
              ...
              <div className="bg-blue-50 rounded-3xl">
                <div className="text-2xl font-bold text-blue-800 mb-2">{score}/3</div>
              ...
              <div className="px-12 py-8">
                ...
                <p className="text-xl text-blue-900 flex align-middle justify-center">
                  Preencha esse formulário e nos ajude a mapear o Recife que vive nas artes.💙
                </p>
                <p className="text-2xl text-blue-800 leading-snug font-semibold">
                  Quer continuar essa viagem?
                </p>
                <p className="text-2xl text-blue-800  leading-snug">
